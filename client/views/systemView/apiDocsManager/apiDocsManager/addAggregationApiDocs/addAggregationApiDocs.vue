    ...
    export default {
        ...
        mounted() {
            ...
            this.$http.getHttp(this.$API.bussinessApiDocsCategorySearch, rs => {
                ...
                this['AddAggregationApiDocsModule/updateCategoryData'](rs.data)
            });
        ...
        computed: {
            ...mapState({
                apiForm  : state => state.AddAggregationApiDocsModule.apiForm,
                categoryData  : state => state.AddAggregationApiDocsModule.categoryData,
                requestRule       : state => state.AddAggregationApiDocsModule.requestRule,
                requestType       : state => state.AddAggregationApiDocsModule.requestType,
                requestPostParams : state => state.AddAggregationApiDocsModule.requestPostParams,
                requestGetParams  : state => state.AddAggregationApiDocsModule.requestGetParams
            })
        },
        //组件方法
        methods: {
            ...mapMutations(['updateCategoryData','AddAggregationApiDocsModule/updateCategoryData']),
            ...mapMutations(['updateRequestPostParams','AddAggregationApiDocsModule/updateRequestPostParams']),
            ...mapMutations(['updateRequestGetParams','AddAggregationApiDocsModule/updateRequestGetParams']),
            ...
            submitForm(form){
                ...
                this.$myLoading.startLoading()
                this.$http.postHttp(this.$API.systemApiAddBussinessApiDocs,params,(rs) => {
                    this.$myLoading.endLoading()
