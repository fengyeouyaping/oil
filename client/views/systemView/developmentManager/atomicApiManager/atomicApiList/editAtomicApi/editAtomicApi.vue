<template>
    <div>
        <el-form :model="atomicApiForm" :rules="rules" label-position="right" ref="atomicApiForm" label-width="160px">
            <el-row><el-col :span="24" class="formTitleBox"><i class="fa fa-cog fa-fw"></i>基本信息：</el-col></el-row>    
            <el-form-item label="所属类别：" prop="ap_api">
                <el-col :span="8">
                    <el-select v-model="atomicApiForm.ap_apcid" placeholder="请选择所属类别">
                        <el-option
            ...
            <!-- <el-form-item label="所属菜单：" prop="belongsMenu">
                <el-col :span="8">
                    <el-cascader style="width:338px;"
                            placeholder="选择父菜单"
                            v-model="atomicApiForm.belongsMenu"
                            :options="menuData">
                    </el-cascader>
                </el-col>
            </el-form-item> -->
            <el-form-item label="接口名称：" prop="ap_name">
                <el-col :span="8">
                    <el-input v-model="atomicApiForm.ap_name" placeholder="请输入接口名称"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="接口地址：" prop="ap_api">
                <el-col :span="8">
                    <el-input v-model="atomicApiForm.ap_api" placeholder="请输入接口地址"></el-input>
                </el-col>
            </el-form-item>
            
            <el-form-item label="请求方式：" prop="ap_method">
                <el-col :span="15">
                    <el-radio v-model="atomicApiForm.ap_method" label="GET" >GET</el-radio>
                    <el-radio v-model="atomicApiForm.ap_method" label="POST" >POST</el-radio>
                    <el-radio v-model="atomicApiForm.ap_method" label="ALL" >ALL</el-radio>
                </el-col>
            </el-form-item>
            
            <el-form-item label="接口描述：" prop="ap_desc">
                <el-col :span="8">
                    <el-input type="textarea" v-model="atomicApiForm.ap_desc" rows="5" placeholder="请输入接口描述"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="接口备注：" prop="ap_note">
                <el-col :span="8">
                    <el-input type="textarea" v-model="atomicApiForm.ap_note" rows="5" placeholder="请输入接口备注"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="是否接受权限控制：" prop="ap_is_control">
                <el-switch v-model="atomicApiForm.ap_is_control"></el-switch>
            </el-form-item>
            ...
            <el-form-item label="是否自动构建：" prop="ap_is_auto">
                <el-switch v-model="atomicApiForm.ap_is_auto"></el-switch>
            </el-form-item>
            <el-form-item label="自动构建类型：" prop="ap_type">
                <el-col :span="15">
                    <el-radio v-model="atomicApiForm.ap_type" label="C" >新增</el-radio>
                    <el-radio v-model="atomicApiForm.ap_type" label="U" >更新</el-radio>
                    <el-radio v-model="atomicApiForm.ap_type" label="R" >查询</el-radio>
                    <el-radio v-model="atomicApiForm.ap_type" label="D" >删除</el-radio>
                </el-col>
            </el-form-item>
            <el-form-item label="自动构建表名：" prop="ap_auto_table">
                <el-col :span="8">
                    <el-input v-model="atomicApiForm.ap_auto_table" placeholder="请输入自动构建表名称"></el-input>
                </el-col>
            </el-form-item>
            ...
            <el-form-item label="是否开启缓存：" prop="ap_is_cache">
                <el-switch v-model="atomicApiForm.ap_is_cache"></el-switch>
            </el-form-item>    
            <el-form-item label="是否使用缓存：" prop="ap_is_get_cache">
                <el-switch v-model="atomicApiForm.ap_is_get_cache"></el-switch>
            </el-form-item>    
            <el-form-item label="缓存类型：" prop="ap_cache_type">
                <el-col :span="15">
                    <el-radio v-model="atomicApiForm.ap_cache_type" label="file" >文件缓存</el-radio>
                </el-col>
            </el-form-item>
            <el-row>
            ...
            <el-row>
                <mavon-editor :toolbars="$global.markdownToolbars" v-model="atomicApiForm.ap_response_params"/>
            </el-row>
            <el-button type="primary" @click="submitForm('atomicApiForm')">提交</el-button>
        </el-form>  
    </div>
</template>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$http.getHttp(this.$API.menuActionPermissionsCategorySearch + "/apc_type/0", rs => {
                this['EditAtomicApiModule/updateCategoryData'](rs.data)
                ...
                //     this['EditAtomicApiModule/updateMenuData'](this.$common.arrayReorganization(rs.data))
                    ...
                    this.$http.getHttp(this.$API.systemApiSearchAtomicApiDetail + "/ap_id/" + this.$route.query.ap_id, rs => {
                        this.$myLoading.endLoading()
                        this['EditAtomicApiModule/updateAtomicApiForm'](rs.apiData)
                        this['EditAtomicApiModule/updateRequestGetParams'](rs.getArr)
                        this['EditAtomicApiModule/updateRequestPostParams'](rs.postArr)
        ...
        computed: {
            ...mapState({
                atomicApiForm  : state => state.EditAtomicApiModule.atomicApiForm,
                requestRule       : state => state.EditAtomicApiModule.requestRule,
                requestType       : state => state.EditAtomicApiModule.requestType,
                actionCategory    : state => state.EditAtomicApiModule.actionCategory,
                requestPostParams : state => state.EditAtomicApiModule.requestPostParams,
                requestGetParams  : state => state.EditAtomicApiModule.requestGetParams
            })
        },
        //组件方法
        methods: {
            ...mapMutations(['updateAtomicApiForm','EditAtomicApiModule/updateAtomicApiForm']),
            ...mapMutations(['updateCategoryData','EditAtomicApiModule/updateCategoryData']),
            ...mapMutations(['updateRequestGetParams','EditAtomicApiModule/updateRequestGetParams']),
            ...mapMutations(['updateRequestPostParams','EditAtomicApiModule/updateRequestPostParams']),
            ...
            submitForm(from){
                ...
                this.$myLoading.startLoading()
                this.$http.postHttp(this.$API.systemApiUpdateActionPermissions,params,(rs) => {
                    this.$myLoading.endLoading()
